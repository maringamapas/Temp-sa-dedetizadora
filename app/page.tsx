            ...
            <div className="flex flex-col gap-6 sm:gap-8">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap items-center gap-4 w-full pt-4 sm:pt-6">
                <motion.a
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 sm:px-8 py-3 bg-amber-500 hover:bg-amber-600 text-black font-semibold text-base rounded-full shadow-lg hover:shadow-amber-500/50 hover:shadow-xl transition-all duration-300"
                >
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  transition={{ type: "spring", stiffness: 300 }}
                  className="w-full sm:w-auto px-6 sm:px-8 py-3 border border-zinc-700 bg-zinc-900/50 hover:bg-amber-500 hover:text-black text-white font-extrabold rounded-full backdrop-blur-sm hover:shadow-amber-500/50 hover:shadow-xl transition-all duration-300 text-center text-2xl"
                >
