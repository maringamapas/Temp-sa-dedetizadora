              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">Empresário</p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-zinc-300 leading-relaxed">
                  &quot;Tranquei minha porta e o chaveiro chegou super rápido. Profissional atencioso e educado. Muito bom!&quot;
                </p>
              </div>
            </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">Administradora</p>
                  </div>
                </div>
                <div className="flex gap-1 mb-3">
                  {[...Array(5)].map((_, i) => (
                ...
                <p className="text-sm sm:text-base text-zinc-300 leading-relaxed">
                  &quot;Fechei meu carro dentro de casa e resolveram rápido sem danificar nada. Equipe super competente!&quot;
                </p>
              </div>
            </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">Comerciante</p>
                  </div>
                </div>
                <div className="flex gap-1 mb-3">
                  {[...Array(5)].map((_, i) => (
