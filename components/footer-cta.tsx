    ...
    <section className="bg-black py-12 px-6 md:px-16 flex flex-col items-center justify-center gap-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center items-center">
        ...
        <motion.a
          ...
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 sm:px-8 py-3 bg-amber-500 hover:bg-amber-600 text-black font-semibold text-base rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
        >
